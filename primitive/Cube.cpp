...
Cube::Cube(GLuint position_attribute, GLuint colour_attribute)
{
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(GLfloat) * 36 * 8, vertices_, GL_STATIC_DRAW);
