...
Triangle::Triangle(GLuint position_attribute, GLuint colour_attribute)
{
    type_ = Primitive::TRIANGLE;

    vertices_ = new GLfloat[3 * 6] {
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(GLfloat) * 3 * 6, vertices_, GL_STATIC_DRAW);
